...
1. Download the latest `.zip` file from [Releases](https://github.com/leonardokr/highlight-me-now/releases).
2. In your IDE, navigate to **Settings/Preferences | Plugins**.
